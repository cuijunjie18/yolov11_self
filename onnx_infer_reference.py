...
if __name__ == "__main__":
    ...
    parser.add_argument("--model", type=str, default="my_install_models/wide_face/best.onnx", help="输入你的 ONNX 模型路径。")
    parser.add_argument("--img", type=str, default=r"data/armors_data/unused_imgs/val/val/nred5407.jpg", help="输入图像的路径。")
